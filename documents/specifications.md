...
| `action_class` | Index dans `RPM_LEVELS = [800, 1500, 2500, 3500, 4500]` — oracle heuristique basé sur `temp_ratio × n_levels`, forcé au max si `status=degraded`. Classe 0 = 800 RPM (plancher, jamais 0). |
